...
describe("product-management route", () => {
  describe("product-management get all products function", () => {
    let mockGetProductsByCategory;
    beforeEach(() => {
      mockGetProductsByCategory = jest.fn().mockReturnValue([
        {
          _id: "1",
          name: "Beans",
          price: 400,
    ...
    test("get all products by category", async () => {
      CategoryManagementService.getAllByCategoryId = mockGetProductsByCategory;

      const response = await request(app)
        .get(`/categories/Vegetable`)
